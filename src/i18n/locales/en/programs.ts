export default {
  ...
  core: {
    ...
    description:
      "Five comprehensive program areas addressing the diverse needs of persons with disabilities and marginalized communities in Nepal.",
    ...
    program1: {
      ...
      image_alt:
        "People with disabilities participating in advocacy and awareness programs",
      features: [
        "Policy advocacy and legal support",
        "Awareness campaigns and community outreach",
        "Rights-based training programs",
        "Accessibility audits and consultations",
      ],
    },
    program2: {
      badge: "Program 02",
      title: "Helpless and Single Women Empowerment",
      description:
        "Supporting vulnerable women through skill training, income generation, and community inclusion.",
      image_alt:
        "Women participating in skill training and empowerment programs",
      features: [
    ...
    program3: {
      badge: "Program 03",
      title: "Life Skills and Education Development",
      description:
      ...
      image_alt:
        "Youth with disabilities learning practical life skills and education",
    },
    program4: {
      badge: "Program 04",
      ...
      image_alt:
        "Persons with disabilities participating in vocational training",
    },
    program5: {
      badge: "Program 05",
      title: "Accessible ICTs and Assistive Technology",
      description:
      ...
      image_alt:
        "Person using assistive technology and accessible digital tools",
    },
  },
  approach: {
    title: "Our Approach",
    description:
      "A comprehensive, rights-based methodology ensuring sustainable impact across all program areas.",
    assessment: {
      title: "Assessment",
      description:
        "Community needs analysis and stakeholder consultation to identify priorities.",
    },
    design: {
      title: "Design",
      description:
        "Evidence-based program development with inclusive participation.",
    },
    implementation: {
      title: "Implementation",
      description:
        "Collaborative execution with continuous monitoring and adaptation.",
    },
    evaluation: {
      title: "Evaluation",
      description:
        "Impact measurement and learning for continuous improvement.",
    },
  },
  cta: {
